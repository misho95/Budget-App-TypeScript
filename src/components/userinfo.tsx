...
const UserInfo = () => {
    return(
        <div className="bg-gray-100 dark:bg-gray-200 p-3 flex flex-col gap-2 rounded-lg shadow-sm shadow-gray-400 text-gray-500 absolute top-10 -left-32 w-60">
            <h1 className='text-lg pl-3 flex gap-1'>Hi <p className='text-purple-500'>Misho Chapidze</p></h1>
            <p className='w-full text-center'>Balance: 7600</p>
